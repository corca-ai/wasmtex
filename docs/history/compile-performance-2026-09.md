# Compile performance experiments — September 2026

Historical record through 2026-09-12. Intermediate decisions below describe their
own build revisions; later sections supersede them. For adopted behavior, use
read [the current performance guide](../compile-performance.md).
