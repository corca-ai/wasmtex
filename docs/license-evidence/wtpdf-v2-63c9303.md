# WTPDF v2 object-model evidence (`63c9303`)
...
this is not release clearance. That statement describes commit `63c9303`; the later
...
| Input | Value |
| --- | --- |
| WTPDF commit | `63c93036def32f9db9c39d25f1ef957c3e5c2308` |
| XeTeX build base | `23f2ce1bc42cb8c5dc710258ea87b3cf729243a0` |
...
[`luahbtex-wtpdf-666663b.md`](luahbtex-wtpdf-666663b.md) for the later build and
dependency audit.
