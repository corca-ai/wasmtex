...
| `npm run gen:tex-semantic-catalog -- --manifest <manifest> --mirror-root <root> --overrides <json> --output <dir>` | Extract and merge versioned class/package semantic shards plus a coverage report |
