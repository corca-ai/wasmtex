...
var u = class {
	...
	forwardFromNodes(e) {
		...
		return r.size > 0 ? this.locationsFromNodes([...r], t) : i.length > 0 ? this.locationsFromNodes(i, t) : this.locationsFromNodes(n, t);
	}
	pointInBox(e, t, n) {
	...
	locationsFromNodes(e, t) {
		let n = [...new Set(e)], r = new Set(n), i = /* @__PURE__ */ new Set();
		for (let e of n) {
			let t = e.parent;
			for (; t;) r.has(t) && i.add(t), t = t.parent;
		}
		let a = n.filter((e) => !i.has(e)), o = [], s = /* @__PURE__ */ new Set();
		for (let e of a) {
			let n = this.bboxFromNodes([e], t), r = `${n.x}:${n.y}:${n.width}:${n.height}`;
			s.has(r) || (s.add(r), o.push(n));
		}
		return o;
	}
	bboxFromNodes(e, t) {
