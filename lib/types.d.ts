...
export type DiagnosticCode = 'tex-error' | 'package-error' | 'missing-package' | 'font-not-found' | 'missing-glyph' | 'undefined-reference' | 'undefined-citation' | 'rerun-needed' | 'overfull-box' | 'package-warning' | 'latex-warning';
...
export type ResolverAttemptSource = 'warmup-cache' | 'persistent-cache' | 'session-cache' | 'warmup-negative' | 'durable-negative' | 'bloom-filter' | 'network';
