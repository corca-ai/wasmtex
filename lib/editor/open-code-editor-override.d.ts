 ...
 */
type OpenCodeEditorFn = (input: unknown, source: unknown, sideBySide: unknown) => Promise<unknown> | unknown;
 ...
 */
export declare function installOpenCodeEditorOverride(service: OpenCodeEditorService, handler: (input: unknown, source: unknown, sideBySide: unknown, original: OpenCodeEditorFn) => Promise<unknown> | unknown): OverrideHandle;
export {};
