import { BIBTEX_STAGE as f } from "./backend-registry.js";
...
function g(t) {
  ...
  for (let i = 0; i < t.length; i++) {
    const r = t[i];
    r !== "{" && r !== "}" || m(t, i) || (r === "{" ? n.push(i) : n.length > 0 ? n.pop() : e.add(i));
  }
...
export {
  w as BIBLIOGRAPHY_STAGE,
  f as BIBTEX_STAGE,
  B as biblatexLiteBackend,
  v as detectBiblatexBackend,
  A as detectBiblatexSort,
  k as detectBibliographyMode,
  y as generateBiblatexBbl,
  C as parseBcfCitedKeys,
  S as resolveBstFile,
  j as runRemoteBibliography,
  E as selectBiblatexBackend
};
