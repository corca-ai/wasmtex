...
var o = class {
	...
	postMessageWithResponse(e, t, n) {
		return new Promise((r, i) => {
			...
			o.push(a), this.pendingResponses.set(t, o);
			try {
				n?.length ? this.worker.postMessage(e, n) : this.worker.postMessage(e);
			} catch (e) {
				let n = o.indexOf(a);
				n !== -1 && o.splice(n, 1), o.length === 0 && this.pendingResponses.get(t) === o && this.pendingResponses.delete(t), i(e);
			}
		});
	}
	deliverResponse(e, t) {
