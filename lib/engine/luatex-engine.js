...
import { LUATEX_RUNTIME_PRELOAD as o } from "./unicode-runtime-manifest.js";
//#region src/engine/luatex-engine.ts
var s = class extends r {
	constructor(r = {}) {
		let s = r.texliveVersion ?? "2025";
		super(i("luatex", r), "wasmtex-luatex.fmt", a("luatex", r), {
			texliveUrl: e(r.texliveUrl ?? null, s),
			preload: [...n, ...o],
			notFound: t
		}, r.persistentCache ? { version: s } : void 0, r.resolverProfile ?? {
			id: `texlive-${s}`,
			texliveYear: s,
			mirrorRevision: null
		}, r.warmupCache);
	...
	async compile() {
		let e = performance.now(), t = await this.ensureFormat(), n = await this.tex.run("compilelatex"), r = `${t}\n${n.log}`.trim(), i = this.result(n.success && !!n.out, n.out, r, e, n.inputFiles, n.inputFilesComplete, [n.resolver]);
...
//#endregion
export { s as WasmTexLuatexEngine };
