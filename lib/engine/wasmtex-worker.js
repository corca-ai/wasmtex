...
import { compileArtifact as n, hasFatalNoOutput as r } from "./compile-output.js";
import { ResolverEvidenceCollector as i } from "./resolver-evidence.js";
...
var s = class extends e {
	...
	async init() {
		this.worker || (this.status = "loading", await new Promise((e, t) => {
			this.worker = a(this.enginePath), this.worker.onmessage = (n) => {
				let r = n.data;
				if (!r.cmd) {
	...
	resolver;
	constructor(e, t, n, r = "pdftex", a = {
		id: `texlive-${n}`,
		texliveYear: n,
		mirrorRevision: null
	}) {
		super(e, t, n), this.resolver = new i(r, a);
	}
	handleProtocolMessage(e) {
	...
	async run(e) {
		...
		let t = await this.postMessageWithResponse({ cmd: e }, "cmd:compile"), i = this.resolver.finish();
		this.status = "ready";
		let a = t.log || "", o = r(a);
		return {
			success: !o && t.result === "ok" && (t.status === 0 || t.status === 1),
			log: a,
			out: n(t.pdf, o),
...
//#endregion
export { c as CompileWorkerDriver, s as WasmTexWorker };
