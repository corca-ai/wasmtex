...
function t(e) {
	let t = e.attempts.find((e) => (e.source === "network" || e.source === "warmup-cache") && e.outcome === "hit" && !!e.candidate);
...
function a(e, t) {
	if (!e || e.texliveVersion !== t.texliveVersion || e.profile.id !== t.profile.id || e.profile.texliveYear !== t.profile.texliveYear || e.profile.mirrorRevision !== t.profile.mirrorRevision) return t;
