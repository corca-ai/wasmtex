...
import { getCodeActions as ne, getDocumentHighlights as I, getDocumentLinks as L, getFoldingRanges as R, getInlayHints as z, getSemanticTokens as B, getSignatureHelp as V, getWorkspaceSymbols as H } from "./lsp/language-features.js";
...
import { bindDiagnosticCompileContext as J } from "./lsp/diagnostic-repair-context.js";
import { IncrementalLinter as Y } from "./lsp/incremental-linter.js";
import { getReferenceProblem as X, planReferenceRepair as Z } from "./lsp/reference-repair.js";
import { referenceRepairDiagnostics as re } from "./lsp/reference-repair-diagnostics.js";
import { LatexSyntaxService as ie } from "./syntax.js";
import { getWrapOptions as ae, planWrapSelection as oe } from "./lsp/wrap-selection.js";
import { HttpTexResourceCatalogProvider as se, InMemoryTexResourceCatalogProvider as Q, TEX_RESOURCE_CATALOG_SCHEMA_VERSION as ce } from "./lsp/resource-catalog.js";
...
var $ = class {
	...
	constructor(e = {}) {
		this.syntaxService = e.syntaxService ?? new ie(), this.index = this.syntaxService.getProjectIndex(), this.lint = e.lint ?? !0, this.linter = new Y(this.lint), this.resourceCatalog = e.resourceCatalog, this.semanticCatalog = e.semanticCatalog, this.mainFile = e.mainFile ?? "main.tex", this.completionProfile = e.completionProfile, this.completionEngine = e.completionEngine, this.completionRegistry = e.completionRegistry ?? k({
	...
	loadProject(e) {
		this.projectRevisionEpoch++, this.fs = new _({ empty: !0 }), this.syntaxService.reset({ documents: [] }), this.index = this.syntaxService.getProjectIndex(), this.documentPaths.clear(), this.documentIds.clear(), this.documentVersions.clear(), this.documentLanguages.clear(), this.linter = new Y(this.lint);
	...
	getDiagnostics() {
		let e = S(this.index), t = this.index.hasFile(this.mainFile) ? [...e.filter((e) => e.code !== "undefined-ref" && e.code !== "duplicate-label"), ...re({
			index: this.index,
			fs: this.fs,
			root: this.mainFile
		})] : e;
	...
	getWrapOptions(e, t, n) {
		return ae(this.wrapSource(e), t, n);
	}
	...
	getDocumentHighlights(e, t, n) {
		return I(e, t, n, this.index);
	}
	getWorkspaceSymbols(e) {
		return H(e, this.index);
	}
	getInlayHints(e) {
		return z(this.textOf(e), this.index);
	}
	getDocumentLinks(e) {
	...
	getCodeActions(e, t) {
		return ne(this.textOf(e), e, t, this.index);
	}
	docFor(e) {
...
//#endregion
export { e as COMPLETION_SNAPSHOT_MAX_ESTIMATED_BYTES, t as COMPLETION_SNAPSHOT_SCHEMA_VERSION, C as CompletionResolverRegistry, ee as DEFAULT_LINT_CONFIG, se as HttpTexResourceCatalogProvider, T as HttpTexSemanticCatalogProvider, Q as InMemoryTexResourceCatalogProvider, E as InMemoryTexSemanticCatalogProvider, $ as LatexLanguageService, g as PackageShardLoader, ce as TEX_RESOURCE_CATALOG_SCHEMA_VERSION, D as TEX_SEMANTIC_CATALOG_SCHEMA_VERSION, p as analyzeCompletionContext, k as createDefaultCompletionRegistry, ue as createLatexLanguageService, s as formatSignature, c as getCommandPackage, l as getCommandSignature, u as getEnvironmentSignature, te as lintSource, y as parseAuxFiles, d as parseSignature, A as preloadSemanticCatalog, b as readAuxFiles, f as registerShard, O as registerTexSemanticShard };
