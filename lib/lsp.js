...
import { HttpTexSemanticCatalogProvider as b, InMemoryTexSemanticCatalogProvider as x, TEX_SEMANTIC_CATALOG_SCHEMA_VERSION as S, registerTexSemanticShard as C } from "./lsp/semantic-catalog.js";
import { createDefaultCompletionRegistry as w, preloadSemanticCatalog as T, provideCompletionResult as E, provideCompletionResultAsync as D, provideDefinition as O, provideHover as k, provideReferences as A } from "./lsp/neutral-providers.js";
...
import { LatexSyntaxService as V } from "./syntax.js";
import { HttpTexResourceCatalogProvider as H, InMemoryTexResourceCatalogProvider as U, TEX_RESOURCE_CATALOG_SCHEMA_VERSION as W } from "./lsp/resource-catalog.js";
...
var K = class {
	...
	constructor(e = {}) {
		this.syntaxService = e.syntaxService ?? new V(), this.index = this.syntaxService.getProjectIndex(), this.lint = e.lint ?? !0, this.linter = new B(this.lint), this.resourceCatalog = e.resourceCatalog, this.semanticCatalog = e.semanticCatalog, this.mainFile = e.mainFile ?? "main.tex", this.completionProfile = e.completionProfile, this.completionRegistry = e.completionRegistry ?? w({
	...
	loadProject(e) {
		this.projectRevisionEpoch++, this.fs = new m({ empty: !0 }), this.syntaxService.reset({ documents: [] }), this.index = this.syntaxService.getProjectIndex(), this.documentPaths.clear(), this.documentIds.clear(), this.documentVersions.clear(), this.documentLanguages.clear(), this.linter = new B(this.lint);
	...
	upsertSyntaxDocument(e) {
		...
		return this.documentPaths.set(e.fileId, e.path), this.documentIds.set(e.path, e.fileId), this.documentVersions.set(e.fileId, e.documentVersion), this.documentLanguages.set(e.fileId, e.language ?? "latex"), e.language !== "markdown" && T(this.completionRegistry, this.index), t;
	}
	...
	configureCompletion(e) {
		this.completionSnapshotUpdate++, this.completionProfile = e.completionProfile, this.resourceCatalog = e.resourceCatalog, this.semanticCatalog = e.semanticCatalog, this.completionRegistry = e.completionRegistry ?? w({
			...e.resourceCatalog ? { resourceCatalog: e.resourceCatalog } : {},
			...e.semanticCatalog ? { semanticCatalog: e.semanticCatalog } : {}
		}), this.index.clearCompletionSnapshot(), T(this.completionRegistry, this.index);
	}
	updateAux(e) {
...
//#endregion
export { e as COMPLETION_SNAPSHOT_MAX_ESTIMATED_BYTES, t as COMPLETION_SNAPSHOT_SCHEMA_VERSION, y as CompletionResolverRegistry, a as DEFAULT_LINT_CONFIG, H as HttpTexResourceCatalogProvider, b as HttpTexSemanticCatalogProvider, U as InMemoryTexResourceCatalogProvider, x as InMemoryTexSemanticCatalogProvider, K as LatexLanguageService, p as PackageShardLoader, W as TEX_RESOURCE_CATALOG_SCHEMA_VERSION, S as TEX_SEMANTIC_CATALOG_SCHEMA_VERSION, v as analyzeCompletionContext, w as createDefaultCompletionRegistry, q as createLatexLanguageService, s as formatSignature, c as getCommandPackage, l as getCommandSignature, u as getEnvironmentSignature, o as lintSource, d as parseSignature, T as preloadSemanticCatalog, f as registerShard, C as registerTexSemanticShard };
