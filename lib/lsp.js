...
import { createDefaultCompletionRegistry as A, preloadSemanticCatalog as j, provideCompletionResult as M, provideCompletionResultAsync as N, provideDefinition as P, provideHover as F, provideReferences as I } from "./lsp/neutral-providers.js";
import { getCodeActions as te, getDocumentHighlights as L, getDocumentLinks as R, getFoldingRanges as z, getInlayHints as B, getSemanticTokens as V, getSignatureHelp as H, getWorkspaceSymbols as U } from "./lsp/language-features.js";
import { parseTraceFile as W } from "./lsp/trace-parser.js";
import { IncrementalLinter as G } from "./lsp/incremental-linter.js";
import { getReferenceProblem as K, planReferenceRepair as q } from "./lsp/reference-repair.js";
import { referenceRepairDiagnostics as J } from "./lsp/reference-repair-diagnostics.js";
import { LatexSyntaxService as Y } from "./syntax.js";
import { getWrapOptions as X, planWrapSelection as Z } from "./lsp/wrap-selection.js";
import { HttpTexResourceCatalogProvider as Q, InMemoryTexResourceCatalogProvider as ne, TEX_RESOURCE_CATALOG_SCHEMA_VERSION as re } from "./lsp/resource-catalog.js";
...
var $ = class {
	...
	getDiagnostics() {
		let e = C(this.index), t = this.index.hasFile(this.mainFile) ? [...e.filter((e) => e.code !== "undefined-ref" && e.code !== "duplicate-label"), ...J({
			index: this.index,
			fs: this.fs,
			root: this.mainFile
		})] : e;
	...
	getWrapOptions(e, t, n) {
		return X(this.wrapSource(e), t, n);
	}
	planWrapSelection(e, t, n) {
		return Z(this.wrapSource(e), t, n);
	}
	...
	getCodeActions(e, t) {
		return te(this.textOf(e), e, t, this.index);
	}
	docFor(e) {
...
//#endregion
export { e as COMPLETION_SNAPSHOT_MAX_ESTIMATED_BYTES, t as COMPLETION_SNAPSHOT_SCHEMA_VERSION, w as CompletionResolverRegistry, g as DEFAULT_LINT_CONFIG, Q as HttpTexResourceCatalogProvider, E as HttpTexSemanticCatalogProvider, ne as InMemoryTexResourceCatalogProvider, D as InMemoryTexSemanticCatalogProvider, $ as LatexLanguageService, _ as PackageShardLoader, re as TEX_RESOURCE_CATALOG_SCHEMA_VERSION, O as TEX_SEMANTIC_CATALOG_SCHEMA_VERSION, p as analyzeCompletionContext, A as createDefaultCompletionRegistry, ae as createLatexLanguageService, s as formatSignature, c as getCommandPackage, l as getCommandSignature, u as getEnvironmentSignature, ee as lintSource, b as parseAuxFiles, d as parseSignature, j as preloadSemanticCatalog, x as readAuxFiles, f as registerShard, k as registerTexSemanticShard };
