import { boundCompletionSnapshot as g, completionProjectRevision as p } from "./engine/completion-snapshot.js";
...
import { IncrementalLinter as h } from "./lsp/incremental-linter.js";
import { getSignatureHelp as F, getFoldingRanges as v, getDocumentHighlights as R, getWorkspaceSymbols as y, getInlayHints as E, getDocumentLinks as T, getSemanticTokens as O, getCodeActions as b } from "./lsp/language-features.js";
import { DEFAULT_LINT_CONFIG as Z, lintSource as ee } from "./lsp/linter.js";
import { createDefaultCompletionRegistry as A, preloadSemanticCatalog as P, provideCompletionResult as L, provideHover as w, provideDefinition as _, provideReferences as I } from "./lsp/neutral-providers.js";
...
import { HttpTexResourceCatalogProvider as ue, InMemoryTexResourceCatalogProvider as ge, TEX_RESOURCE_CATALOG_SCHEMA_VERSION as pe } from "./lsp/resource-catalog.js";
import { HttpTexSemanticCatalogProvider as xe, InMemoryTexSemanticCatalogProvider as Ce, TEX_SEMANTIC_CATALOG_SCHEMA_VERSION as Se, registerTexSemanticShard as Fe } from "./lsp/semantic-catalog.js";
function l(s) {
...
class H {
  ...
  constructor(e = {}) {
    this.lint = e.lint ?? !0, this.linter = new h(this.lint), this.resourceCatalog = e.resourceCatalog, this.semanticCatalog = e.semanticCatalog, this.mainFile = e.mainFile ?? "main.tex", this.completionProfile = e.completionProfile, this.completionRegistry = e.completionRegistry ?? A({
  ...
  loadProject(e) {
    this.projectRevisionEpoch++, this.fs = new d({ empty: !0 }), this.index = new u(), this.linter = new h(this.lint);
  ...
  updateFile(e, t) {
    if (this.fs.readFile(e) !== t) {
      ...
      l(e) && (this.index.updateFile(e, t), P(this.completionRegistry, this.index)), e.toLowerCase().endsWith(".bib") && this.index.updateBibFile(e, x(t, e));
    }
  }
  removeFile(e) {
  ...
  async updateCompletionSnapshot(e) {
    ...
    }), m = await p(r), n = o === this.projectRevisionEpoch && t.identity.projectRevision === m && t.identity.root === this.mainFile && this.fs.readFile(this.mainFile) !== null;
  ...
  getDocumentHighlights(e, t, i) {
    return R(e, t, i, this.index);
  }
  getWorkspaceSymbols(e) {
    return y(e, this.index);
  }
  getInlayHints(e) {
    return E(this.textOf(e), this.index);
  }
  getDocumentLinks(e) {
    return T(this.textOf(e));
  }
  getSemanticTokens(e) {
...
export {
  ...
  ue as HttpTexResourceCatalogProvider,
  xe as HttpTexSemanticCatalogProvider,
  ge as InMemoryTexResourceCatalogProvider,
  Ce as InMemoryTexSemanticCatalogProvider,
  ...
  A as createDefaultCompletionRegistry,
