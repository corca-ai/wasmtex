...
function c(e, t) {
	...
	return e.snippet && (a.insertTextRules = n.languages.CompletionItemInsertTextRule.InsertAsSnippet), e.detail && (a.detail = e.detail), e.documentation && (a.documentation = { value: e.documentation }), e.sortText && (a.sortText = e.sortText), e.filterText && (a.filterText = e.filterText), e.data && (a.data = e.data), a;
}
//#endregion
