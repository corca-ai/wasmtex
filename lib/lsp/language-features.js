...
import { getCommandPackage as o, getCommandSignature as s } from "./package-db.js";
import { analyzeCompletionContext as c } from "./completion-context.js";
...
function f(e, t, n, r) {
	...
	let o = `${a.command}${a.starred ? "*" : ""}`, l = r?.getCommandArguments(o) ?? s(o);
	if (!l?.length) return null;
	let u = l.map((e) => e.kind === "required" ? `{${e.placeholder || "arg"}}` : `[${e.placeholder || "opt"}]`);
	return {
