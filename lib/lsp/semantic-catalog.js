...
function g(r, t, e) {
  ...
  const s = r;
  if (s.scope?.id !== t || !Array.isArray(s.keyFamilies) || !Array.isArray(s.commands) || !Array.isArray(s.environments) || !Array.isArray(s.dependencies))
...
class p {
  ...
  async loadShard(t) {
    try {
      ...
      const i = await this.read(s.path, s.sha256), a = g(JSON.parse(i), t, this.identity);
