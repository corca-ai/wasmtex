//#region src/lsp/latex-commands.ts
var e = [
	{
		name: "documentclass",
	...
	},
	{
		...
		snippet: "\\ref{$1}",
		detail: "Reference",
		documentation: "Reference a label."
	},
	{
		name: "pageref",
		snippet: "\\pageref{$1}",
	...
	},
	{
		name: "subseteq",
		snippet: "\\subseteq",
		detail: "Subset or equal"
	},
	{
		name: "supseteq",
		snippet: "\\supseteq",
		detail: "Superset or equal"
	},
	{
		name: "in",
		snippet: "\\in",
	...
	},
	{
		name: "Rightarrow",
		snippet: "\\Rightarrow",
		detail: "Double right arrow"
	},
	{
		name: "Leftarrow",
		snippet: "\\Leftarrow",
		detail: "Double left arrow"
	},
	{
		name: "leftrightarrow",
	...
	},
	{
		name: "epsilon",
		snippet: "\\epsilon",
		detail: "Greek epsilon"
	},
	{
		name: "varepsilon",
		snippet: "\\varepsilon",
		detail: "Greek varepsilon"
	},
	{
		name: "zeta",
		snippet: "\\zeta",
	...
	{
		name: "left",
		snippet: "\\left$1 $0 \\right$2",
		detail: "Left delimiter"
	},
	{
		name: "right",
		snippet: "\\right$1",
		detail: "Right delimiter"
	},
	{
		name: "langle",
		snippet: "\\langle",
		detail: "Left angle bracket"
	},
	{
		name: "rangle",
		snippet: "\\rangle",
		detail: "Right angle bracket"
	},
	{
		name: "lfloor",
		snippet: "\\lfloor",
	...
	},
	{
		name: "vdots",
		snippet: "\\vdots",
		detail: "Vertical dots"
	},
	{
		name: "ddots",
		snippet: "\\ddots",
		detail: "Diagonal dots"
	},
	{
		name: "times",
		snippet: "\\times",
	...
	{
		name: "rotatebox",
		snippet: "\\rotatebox{$1}{$2}",
		detail: "Rotate box",
		package: "graphicx"
	},
	{
		name: "scalebox",
		snippet: "\\scalebox{$1}{$2}",
		detail: "Scale box",
		package: "graphicx"
	},
	{
...
var c = [
	...
	{
		name: "tabular",
		snippet: "\\begin{tabular}{$1}\n	$0\n\\end{tabular}",
		detail: "Tabular"
	},
	{
		name: "center",
		snippet: "\\begin{center}\n	$0\n\\end{center}",
		detail: "Centered text"
	},
	{
		name: "quote",
		snippet: "\\begin{quote}\n	$0\n\\end{quote}",
...
for (let e of c) l.set(e.name, e);
function u(e) {
	return l.get(e);
}
//#endregion
export { a as LATEX_COMMANDS, c as LATEX_ENVIRONMENTS, s as getCommandByName, u as getEnvironmentByName };
