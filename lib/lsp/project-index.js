...
class L {
  ...
  removeFromIndexes(e, t) {
    b(this.labelDefIndex, t.labels, (n) => n.name, e), b(this.labelRefIndex, t.labelRefs, (n) => n.name, e), b(this.citationIndex, t.citations, (n) => n.key, e), b(this.bibItemIndex, t.bibItems, (n) => n.key, e), b(this.commandIndex, t.commands, (n) => n.name, e), b(this.commandRefIndex, t.commandUses, (n) => n.name, e), b(this.envDefIndex, t.environmentDefs, (n) => n.name, e);
  }
  updateAux(e) {
    this.auxData = I(e);
  }
  ...
  itemsInScope(e, t) {
    ...
    const n = new Set(this.getActiveFiles(e)), { reverse: s } = this.includeGraph(), o = [...n].filter((r) => ![...s.get(r) ?? []].some((h) => n.has(h))).sort(), i = [], a = (r, h) => {
      ...
      const m = new Set(h).add(r), u = [
        ...
        (f, g) => f.location.line - g.location.line || f.location.column - g.location.column || f.type.localeCompare(g.type) || f.order - g.order
      );
      for (const f of u)
