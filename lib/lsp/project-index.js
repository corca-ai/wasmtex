...
var u = class {
	...
	updateFile(e, n) {
		...
		r && this.removeFromIndexes(e, r);
		let i = t(n, e);
		this.files.set(e, i), this.addToIndexes(i), this.allLabelsCache = null, this.activeFilesCache.clear(), this.activeBibFilesCache.clear();
	}
	removeFile(e) {
		this.invalidateCompletionSnapshot();
