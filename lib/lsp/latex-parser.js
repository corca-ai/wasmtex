...
function Z(e, t, n, r, i) {
	let a = n.get(e);
	if (!a || r > wt || i.has(e)) return "";
	let o = a.body.replace(/#(\d)/g, (e, n) => t[Number(n) - 1] ?? "");
	return o = o.replace(/\\(\w+)/g, (t, a, s) => {
		let c = n.get(a);
		if (!c) return t;
		let { args: l } = X(o, s + t.length, c.argCount, c.optional), u = new Set(i);
		return u.add(e), Z(a, l, n, r + 1, u);
	}), o;
}
var Tt = RegExp(`(?:\\\\(?:${r}|DeclareMathOperator)\\*?\\{|\\\\def)$`);
function Q(e, t) {
	return Tt.test(e.slice(Math.max(0, t - 24), t));
}
function Et(e) {
	let t = K(e);
	if (t.size === 0) return [];
...
function kt(e, t) {
	let n = {
		...
		file: t,
		groupEnds: _(r),
		commandOccurrences: w(r)
	}, a = g(r, Et(r)), o = {
		...i,
		masked: a,
		groupEnds: _(a),
		commandOccurrences: w(a)
	};
	return Pe(o, n), Fe(o, n), Ie(o, n), Le(i, n), Re(i, n), ze(i, n), He(i, n), Ve(i, n), Ue(i, n), We(i, n), Ge(i, n), Ke(i, n), Je(i, n), qe(i, n), ft(i, n), pt(i, n), Xe(i, n), Ze(i, n), Qe(i, n), rt(i, n), xt(i, n), Ye(i, n), Dt(i, n), n;
}
//#endregion
export { oe as maskSpans, se as maskSpansFromTokens, kt as parseLatexFile };
