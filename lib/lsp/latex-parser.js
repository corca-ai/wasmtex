...
var b = /\\label\{/g, x = RegExp(`\\\\(?:${i})\\{`, "g"), S = RegExp(`\\\\(?:${e})(?:\\[[^\\]]*\\])*\\{`, "g"), ce = RegExp(`\\\\(${a})\\*?(?:\\[[^\\]]*\\])?\\{`, "g"), le = new RegExp(String.raw`\\(${r}|(?:New|Renew|Provide|Declare)(?:Expandable)?DocumentCommand)\*?\s*(?:\{\s*${t}\s*\}|${t})\s*(?:\[(\d+)\])?`, "g"), ue = new RegExp(String.raw`\\(?:def|gdef|edef|xdef|let|futurelet)\s*${t}`, "g"), de = /\\DeclareMathOperator\*?\{\\(\w+)\}/g, fe = /\\begin\{/g, pe = RegExp(`\\\\(${n})\\{`, "g"), me = RegExp(`\\\\(?:${o})(?:\\[([^\\]]*)\\])?\\{`, "g"), he = /\\(definecolorset|providecolorset|preparecolorset|DefineNamedColor|definecolor|xdefinecolor|providecolor|colorlet)\*?(?![A-Za-z@:_])/g, ge = /\\(definecolors|providecolors)(?!et)\*?\s*\{/g, _e = /\\(newcounter|providecounter|newaliascnt|setcounter|addtocounter|stepcounter|refstepcounter|value|counterwithin|counterwithout)\*?\s*\{/g, ve = /\\(setlength|addtolength|settowidth|settoheight|settodepth)\*?\s*\{\s*(\\[A-Za-z@]+)\s*\}/g, ye = /\\(newlength|newdimen|newskip)\s*(?:\{\s*(\\[A-Za-z@]+)\s*\}|(\\[A-Za-z@]+))/g, be = /\\pgfkeys\s*\{/g, xe = /* @__PURE__ */ new Set(["bibitem"]), Se = /* @__PURE__ */ new Set([
	"newenvironment",
	"renewenvironment",
	...
	"addglobalbib",
	"addsectionbib"
]), Te = /* @__PURE__ */ new Set(["longnewglossaryentry", "newglossaryentry"]), Ee = /* @__PURE__ */ new Set([
	"gls",
	"Gls",
	"glspl",
	"Glspl",
	...
	"Glsentrysymbolplural",
	"glsadd"
]), De = /* @__PURE__ */ new Set(["newacronym"]), Oe = /* @__PURE__ */ new Set([
	"acrshort",
	"Acrshort",
	"ACRshort",
	"acrlong",
	...
	"setmonofont",
	"fontspec"
]), Ae = /* @__PURE__ */ new Set(["newfontfamily", "newfontface"]), je = /* @__PURE__ */ new Set(["DeclareFontFamily"]), Me = /* @__PURE__ */ new Set([
	"definekey",
	"define@key",
	"defineboolkey",
	"definechoicekey",
...
function Le(e, t) {
	let n = K(e.masked);
	for (let r of e.masked.matchAll(ce)) {
...
function M(e, t, n, r, i, a = !1) {
	...
	i && (o.argCount = Number.parseInt(i, 10)), a && (o.mayRedefine = !0), r.commands.push(o);
}
function Re(e, t) {
	for (let n of e.masked.matchAll(le)) {
		let r = n[2] ?? n[3];
		M(e, r, e.masked.indexOf(`\\${r}`, n.index + 1), t, n[4], n[1] !== "newcommand" && n[1] !== "NewDocumentCommand" && n[1] !== "NewExpandableDocumentCommand");
	}
}
function ze(e, t) {
...
function Qe(e, t) {
	P(e, Te, t.glossaryEntries, "definition"), P(e, Ee, t.glossaryEntries, "usage"), P(e, De, t.acronymEntries, "definition"), P(e, Oe, t.acronymEntries, "usage");
}
function $e(e, t) {
	if (e[t] !== "\\") return null;
	let n = t + 1;
...
function rt(e, t) {
	P(e, ke, t.fontFamilies, "usage"), tt(e, t), nt(e, t);
}
function it(e, t, n) {
	let r = e[t];
	if (r !== "{" && r !== "[") return null;
...
var W = RegExp(`\\\\(?:${r})\\*?\\{\\\\(\\w+)\\}(?:\\[(\\d+)\\])?(?:\\[([^\\]]*)\\])?\\s*\\{`, "g"), G = /\\def\\(\w+)((?:#\d)*)\s*\{/g, St = /\\DeclareMathOperator(\*)?\{\\(\w+)\}\s*\{/g, Ct = new RegExp(String.raw`\\(?:${r})\*?\s*(?:\{\s*\\[\w@]+\s*\}|\\[\w@]+)\s*(?:\[\d+\]\s*)?(?:\[[^\]]*\]\s*)?\{`, "g"), wt = /\\(?:def|gdef|edef|xdef)\s*\\[\w@]+/g;
function K(e) {
	let t = v(e), n = Tt(e, t);
	for (let r of e.matchAll(Ct)) {
		let i = r.index + r[0].length - 1, a = y(e, i, t);
		n.push([r.index, a === null ? e.length : i + a.length + 2]);
	}
	return n;
}
function Tt(e, t) {
	let n = [], r = new RegExp(wt), i = /[{}]/g;
	for (let a = r.exec(e); a; a = r.exec(e)) {
		i.lastIndex = r.lastIndex;
		let o = i.exec(e);
		if (!o) break;
		if (r.lastIndex = o.index + 1, o[0] !== "{") continue;
		let s = o.index, c = y(e, s, t), l = c === null ? e.length : s + c.length + 2;
...
var Dt = RegExp(`\\\\(?:label|${i}|${e})\\b`);
function J(e) {
	let t = /* @__PURE__ */ new Set(), n = !0;
	for (; n;) {
		n = !1;
		for (let [r, i] of e) t.has(r) || (Dt.test(i.body) || Ot(i.body, e, t)) && (t.add(r), n = !0);
	}
	return t;
}
function Ot(e, t, n) {
...
function Z(e, t, n, r, i) {
	let a = n.get(e);
	return !a || r > At || i.has(e) ? "" : jt(a.body.replace(/#(\d)/g, (e, n) => t[Number(n) - 1] ?? ""), n, r, /* @__PURE__ */ new Set([...i, e]));
}
function jt(e, t, n, r) {
	let i = 0, a = "";
...
var Mt = RegExp(`(?:\\\\(?:${r}|DeclareMathOperator)\\*?\\{|\\\\def)$`);
function Q(e, t) {
	return Mt.test(e.slice(Math.max(0, t - 24), t));
}
function Nt(e) {
	let t = q(e);
	if (t.size === 0) return [];
...
function Rt(e, t, n = c(e)) {
	...
	return Pe(s, r), Fe(s, r), Ie(s, r), Le(a, r), Re(a, r), ze(a, r), He(a, r), Ve(a, r), Ue(a, r), We(a, r), Ge(a, r), Ke(a, r), Je(a, r), qe(a, r), ft(a, r), pt(a, r), Xe(a, r), Ze(a, r), Qe(a, r), rt(a, r), xt(a, r), Ye(a, r), Pt(a, r), r;
}
//#endregion
export { Ft as collectUserMacroDefinitions, It as expandUserMacroCalls, Et as macroDefinitionSpansFromTokens, oe as maskSpans, se as maskSpansFromTokens, Rt as parseLatexFile };
