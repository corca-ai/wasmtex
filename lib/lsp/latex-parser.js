...
function K(e) {
	let t = [], n = v(e);
	for (let r of [Ct, wt]) for (let i of e.matchAll(r)) {
		let r = i.index + i[0].length - 1, a = y(e, r, n);
		t.push([i.index, a === null ? e.length : r + a.length + 2]);
	}
	return t;
}
function Tt(e, t) {
...
var Et = RegExp(`\\\\(?:label|${i}|${e})\\b`);
function J(e) {
	let t = /* @__PURE__ */ new Set(), n = !0;
	for (; n;) {
		n = !1;
		for (let [r, i] of e) t.has(r) || (Et.test(i.body) || Dt(i.body, e, t)) && (t.add(r), n = !0);
	}
	return t;
}
function Dt(e, t, n) {
...
function Z(e, t, n, r, i) {
	let a = n.get(e);
	return !a || r > kt || i.has(e) ? "" : At(a.body.replace(/#(\d)/g, (e, n) => t[Number(n) - 1] ?? ""), n, r, /* @__PURE__ */ new Set([...i, e]));
}
function At(e, t, n, r) {
	let i = 0, a = "";
...
var jt = RegExp(`(?:\\\\(?:${r}|DeclareMathOperator)\\*?\\{|\\\\def)$`);
function Q(e, t) {
	return jt.test(e.slice(Math.max(0, t - 24), t));
}
function Mt(e) {
	let t = q(e);
	if (t.size === 0) return [];
...
function Ft(e, t = /* @__PURE__ */ new Map()) {
	let n = new Map(t);
...
function Lt(e, t, n = c(e)) {
	...
	return Pe(s, r), Fe(s, r), Ie(s, r), Le(a, r), Re(a, r), ze(a, r), He(a, r), Ve(a, r), Ue(a, r), We(a, r), Ge(a, r), Ke(a, r), Je(a, r), qe(a, r), ft(a, r), pt(a, r), Xe(a, r), Ze(a, r), Qe(a, r), rt(a, r), xt(a, r), Ye(a, r), Nt(a, r), r;
}
//#endregion
export { Pt as collectUserMacroDefinitions, Ft as expandUserMacroCalls, Tt as macroDefinitionSpansFromTokens, oe as maskSpans, se as maskSpansFromTokens, Lt as parseLatexFile };
