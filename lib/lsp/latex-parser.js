...
function v(e) {
	...
	for (let i = 0; i < e.length; i++) {
		...
		if (a === "{") n.push(i);
		else if (a === "}") r.delete(n.length), ue(t, n.pop(), i);
		else if (a === "[") {
			let e = r.get(n.length) ?? [];
			e.push(i), r.set(n.length, e);
		} else a === "]" && (le(t, r.get(n.length), i), r.delete(n.length));
	}
	return t;
}
function le(e, t, n) {
...
function He(e, t) {
	for (let n of e.masked.matchAll(pe)) {
		let r = n[2] ?? n[3], i = j(e, r, e.masked.indexOf(`\\${r}`, n.index + 1), t, n[4], n[1] !== "newcommand" && n[1] !== "NewDocumentCommand" && n[1] !== "NewExpandableDocumentCommand"), a = Ge(e, n);
...
function ut(e, t) {
	N(e, Ne, t.fontFamilies, "usage"), ct(e, t), lt(e, t);
}
function dt(e, t, n) {
	let r = e[t];
	if (r !== "{" && r !== "[") return null;
...
function Ct(e, t) {
	for (let n of w(e, Le)) {
		...
		for (let e of I(i.value)) St(s, c, e, o, i.contentStart + l), l += e.length + 1;
		H(e, t, s, c);
	}
}
function U(e, t) {
...
function Et(e, t) {
	for (let n of e.masked.matchAll(we)) {
		...
		for (let e of I(i)) Tt(a, e.trim(), r + 1 + o), o += e.length + 1;
...
var W = RegExp(`\\\\(?:${i})\\*?\\{\\\\(\\w+)\\}(?:\\[(\\d+)\\])?(?:\\[([^\\]]*)\\])?\\s*\\{`, "g"), G = /\\def\\(\w+)((?:#\d)*)\s*\{/g, Ot = /\\DeclareMathOperator(\*)?\{\\(\w+)\}\s*\{/g, kt = new RegExp(String.raw`\\(?:${i})\*?\s*(?:\{\s*\\[\w@]+\s*\}|\\[\w@]+)\s*(?:\[\d+\]\s*)?(?:\[[^\]]*\]\s*)?\{`, "g"), At = /\\(?:def|gdef|edef|xdef)\s*\\[\w@]+/g;
function K(e) {
	let t = v(e), n = jt(e, t);
...
var Nt = RegExp(`\\\\(?:label|${a}|${t})\\b`);
function J(e) {
	let t = /* @__PURE__ */ new Set(), n = !0;
	for (; n;) {
		n = !1;
		for (let [r, i] of e) t.has(r) || (Nt.test(i.body) || Pt(i.body, e, t)) && (t.add(r), n = !0);
	}
	return t;
}
function Pt(e, t, n) {
...
function Z(e, t, n, r, i) {
	let a = n.get(e);
	return !a || r > It || i.has(e) ? "" : Lt(a.body.replace(/#(\d)/g, (e, n) => t[Number(n) - 1] ?? ""), n, r, /* @__PURE__ */ new Set([...i, e]));
}
function Lt(e, t, n, r) {
	let i = 0, a = "";
...
var Rt = RegExp(`(?:\\\\(?:${i}|DeclareMathOperator)\\*?\\{|\\\\def)$`);
function Q(e, t) {
	return Rt.test(e.slice(Math.max(0, t - 24), t));
}
function zt(e) {
	let t = q(e);
	if (t.size === 0) return [];
...
function Ht(e, t = /* @__PURE__ */ new Map()) {
	let n = new Map(t);
...
function Wt(e, t, n = l(e)) {
	...
	return Re(s, r), ze(s, r), Be(s, r), Ve(a, r), He(a, r), Ke(a, r), Ye(a, r), Je(a, r), Xe(a, r), Ze(a, r), Qe(a, r), $e(a, r), tt(a, r), et(a, r), vt(a, r), yt(a, r), rt(a, r), it(a, r), at(a, r), ut(a, r), Dt(a, r), nt(a, r), Bt(a, r), r;
}
//#endregion
export { Vt as collectUserMacroDefinitions, Ht as expandUserMacroCalls, Mt as macroDefinitionSpansFromTokens, se as maskSpans, ce as maskSpansFromTokens, Wt as parseLatexFile };
