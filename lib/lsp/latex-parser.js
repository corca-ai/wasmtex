...
var W = RegExp(`\\\\(?:${r})\\*?\\{\\\\(\\w+)\\}(?:\\[(\\d+)\\])?(?:\\[([^\\]]*)\\])?\\s*\\{`, "g"), G = /\\def\\(\w+)((?:#\d)*)\s*\{/g, St = /\\DeclareMathOperator(\*)?\{\\(\w+)\}\s*\{/g;
function K(e) {
...
var Ct = RegExp(`\\\\(?:label|${i}|${e})\\b`);
function q(e) {
	let t = /* @__PURE__ */ new Set(), n = !0;
	for (; n;) {
		n = !1;
		for (let [r, i] of e) t.has(r) || (Ct.test(i.body) || wt(i.body, e, t)) && (t.add(r), n = !0);
	}
	return t;
}
function wt(e, t, n) {
...
function X(e, t, n, r, i) {
	let a = n.get(e);
	return !a || r > Et || i.has(e) ? "" : Dt(a.body.replace(/#(\d)/g, (e, n) => t[Number(n) - 1] ?? ""), n, r, /* @__PURE__ */ new Set([...i, e]));
}
function Dt(e, t, n, r) {
	let i = 0, a = "";
	for (let o of e.matchAll(/\\(\w+)/g)) {
		let s = o[1], c = t.get(s);
		if (!c) continue;
		let { args: l } = Y(e, o.index + o[0].length, c.argCount, c.optional), u = X(s, l, t, n + 1, new Set(r));
		a += e.slice(i, o.index), a += u || e.slice(o.index, o.index + o[0].length), i = Y(e, o.index + o[0].length, c.argCount, c.optional).end;
	}
	return a + e.slice(i);
}
var Z = RegExp(`(?:\\\\(?:${r}|DeclareMathOperator)\\*?\\{|\\\\def)$`);
function Q(e, t) {
	return Z.test(e.slice(Math.max(0, t - 24), t));
}
function Ot(e) {
	let t = K(e);
	if (t.size === 0) return [];
...
function kt(e, t) {
	...
	if (r.size !== 0) for (let i of e.masked.matchAll(/\\(\w+)/g)) {
		...
		let o = n.get(a), { args: s } = Y(e.masked, i.index + i[0].length, o.argCount, o.optional), c = X(a, s, n, 0, /* @__PURE__ */ new Set());
		c && Mt(c, k(e, i.index), t);
	}
}
function At(e) {
	let t = /* @__PURE__ */ new Map();
	for (let n of e) for (let [e, r] of K(n)) t.set(e, r);
	return t;
}
function jt(e, t = /* @__PURE__ */ new Map()) {
	let n = new Map(t);
	for (let [t, r] of K(e)) n.set(t, r);
	if (n.size === 0) return [];
	let r = [];
	for (let t of e.matchAll(/\\(\w+)/g)) {
		let i = t[1], a = n.get(i);
		if (!a || Q(e, t.index)) continue;
		let o = Y(e, t.index + t[0].length, a.argCount, a.optional);
		if (o.args.length !== a.argCount) continue;
		let s = X(i, o.args, n, 0, /* @__PURE__ */ new Set());
		s && r.push({
			name: i,
			inputStart: t.index,
			inputEnd: o.end,
...
function Nt(e, t, n = c(e)) {
	...
	return Pe(s, r), Fe(s, r), Ie(s, r), Le(a, r), Re(a, r), ze(a, r), He(a, r), Ve(a, r), Ue(a, r), We(a, r), Ge(a, r), Ke(a, r), Je(a, r), qe(a, r), ft(a, r), pt(a, r), Xe(a, r), Ze(a, r), Qe(a, r), rt(a, r), xt(a, r), Ye(a, r), kt(a, r), r;
}
//#endregion
export { At as collectUserMacroDefinitions, jt as expandUserMacroCalls, oe as maskSpans, se as maskSpansFromTokens, Nt as parseLatexFile };
