...
import { analyzeCompletionContext as u } from "./completion-context.js";
import { formatReference as d } from "./bib-parser.js";
import { registerBibCompletionResolvers as ee } from "./bib-completion.js";
import { completeColors as te } from "./color-completion.js";
...
function m(e = {}) {
	...
	n && p.set(t, n), ee(t), t.registerResolver("command", (e, t) => {
