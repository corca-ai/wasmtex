...
var t = (e, t, n = {}) => ({
	...
	["else", []],
	["fi", []],
	["textbf", [n("text", "free-text")]],
	["textit", [n("text", "free-text")]],
	["texttt", [n("text", "free-text")]],
	["textrm", [n("text", "free-text")]],
	["textsf", [n("text", "free-text")]],
	["textnormal", [n("text", "free-text")]],
	["emph", [n("text", "free-text")]],
	["frac", [n("numerator", "free-text"), n("denominator", "free-text")]],
	["sqrt", [t("index", "free-text"), n("radicand", "free-text")]],
...
for (let e of [
	...
	"paragraph",
	"subparagraph"
]) r.set(e, [t("short title", "free-text"), n("title", "free-text")]), r.set(`${e}*`, [n("title", "free-text")]);
function i(e) {
