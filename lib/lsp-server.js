...
var s = class {
	...
	service;
	constructor(t, n) {
		this.send = t, this.service = new e(n);
	}
	handle(e) {
		if (e.method) try {
	...
	didOpen(e) {
		...
		this.service.updateFile(a(t.uri), t.text ?? ""), this.publishAllDiagnostics();
	}
	didChange(e) {
		let t = e?.textDocument ?? {}, n = e?.contentChanges ?? [];
		n.length && (this.service.updateFile(a(t.uri), n[n.length - 1].text), this.publishAllDiagnostics());
	}
	completion(e) {
