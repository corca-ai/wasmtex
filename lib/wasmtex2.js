...
import { registerLatexProviders as $ } from "./lsp/register-providers.js";
import { parseTraceFile as W } from "./lsp/trace-parser.js";
import { initPerfOverlay as N, perf as a } from "./perf/metrics.js";
import { SynctexParser as H } from "./synctex/synctex-parser.js";
/* empty css                   */
import { setErrorMarkers as X, setDiagnosticMarkers as z } from "./ui/error-markers.js";
import { PdfViewer as q } from "./viewer/pdf-viewer.js";
...
class Re {
  ...
  initViewer() {
    ...
    this.pdfViewer = new q(this.previewContainer), this.pdfViewer.setInverseSearchHandler((e) => {
  ...
  initRuntimeServices() {
    ...
    ), this.perfOverlayDispose = N(), this.unhandledRejectionHandler = (e) => {
  ...
  handlePostCompile(e, i = !1) {
    ...
    X(e.errors, this.models.values()), this.updateAuxIndex(), this.emitOutline(), this.runDiagnostics(), this.pendingBibtex || this.maybeRunBibtex(e), this.pendingBibtex || this.maybeRecompile(e), this.emit("compile", { result: e }), this.armPrebuild();
  }
  ...
  runDiagnostics() {
    ...
    z(e, this.models.values()), this.emit("diagnostics", { diagnostics: e });
  }
  downloadPdf() {
