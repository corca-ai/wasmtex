...
var $ = class {
	...
	attachTexliveDependencies(e, t) {
		let n = Z(this.opts.texliveVersion ?? "2025", this.completionProfile(), t);
		n && (e.telemetry ??= { diagnostics: j(e.log) }, e.telemetry.texliveDependencies = n);
	}
