...
var be = [
	...
	async ensureEngine() {
		if (this.detection = le(this.mainSource(), this.opts.engine), !(this.engine && this.detection.engine === this.engineKind)) {
			this.engine?.terminate(), this.engineKind = this.detection.engine, this.engine = se(this.detection.engine, this.engineBaseOpts()), this.attachLoadProgress(this.engine), this.incremental = this.opts.incremental && this.engine instanceof k ? new A(this.engine, { mainFile: this.mainFile }) : null, this.heap = this.opts.incremental && this.engine instanceof k ? new (await (import("./engine/heap-checkpoints.js"))).HeapCheckpointCompiler(this.engine, { mainFile: this.mainFile }) : null;
			try {
