...
import { buildDependencyManifest as D, buildIncrementalDependencyManifest as oe, normalizeProjectDependencyPath as O } from "./engine/dependency-manifest.js";
...
var we = [
	...
	async compileIdle() {
		...
		let o = r.telemetry?.tikzExternalization, s = (await this.operations.observe(this.runAuxStages(r))).resume(), c = new A();
